...
start_game:
#desenho do display 
li $t0,13558565 # color: amarelo claro 13558565 amarelo escuro 15793920
li $a0,120		#cord x
li $a1,75		#largra
li $a2,100		#CORD Y
li $a3,75		#altura
...
li $t0, 2453479	#azul escuro 1275 azul claro 2452479
li $a0,220		#cord x
li $a1, 75		#largra
li $a2, 177		#CORD Y
li $a3, 75		#altura
...
li $t0, 505389	#505389 verde claro 587264 escuro
li $a0, 220		#cord x
li $a1, 75		#largra
li $a2, 5		#CORD Y
li $a3, 75		#altura
...
vermelho: 	
	...
	j end_game
azul:
	li $t0, 1275	#azul escuro 1275 azul claro 2452479
	li $a0,220		#cord x
	li $a1, 75		#largra
	li $a2, 177		#CORD Y
	li $a3, 75		#altura
	...
	j end_game
verde:
	li $t0, 587264	#505389 verde claro 587264 escuro
	li $a0, 220		#cord x
	li $a1, 75		#largra
	li $a2, 5		#CORD Y
	li $a3, 75		#altura
	...
	j end_game
amarelo:
	li $t0,15793920 # color: amarelo claro 13558565 amarelo escuro 15793920
	li $a0,120		#cord x
	li $a1,75		#largra
	li $a2,100		#CORD Y
	li $a3,75		#altura
